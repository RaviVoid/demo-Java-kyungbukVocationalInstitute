...
public class ArrayExam12 {
	...
	public static void main(String[] args) {
		...
		for (i = 0; i < arr.length; i++) {
			...
			if (arr[i] > max) {
				// arr[i]번째 값이 temp보다 크면 temp에 값을 저장한다
		...
		// int 함수의 최소값과 최대값을 입력/출력
		int test1 = Integer.MIN_VALUE;// Integer.MIN
		System.out.printf("Integer.MIN_VALUE = %d\n", test1);
		int test2 = Integer.MAX_VALUE;// Integer.MIN
